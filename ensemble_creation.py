...
if __name__ == '__main__':
    ...
    alergia_traces = compute_clustering_function_and_map_to_traces(traces, action_map, env_name, include_reward=False,
                                                                   ...
                                                                   scale=scale,)[0]
    compute_ensemble_mdp(alergia_traces,suffix_strategy="all_nonconsec",optimize_for="accuracy",input_completeness="sink_state",alergia_eps=0.05,
